...
class Home extends React.PureComponent {
  static async getInitialProps({ req, store, dispatch, user }) {
    ...
    if (user && user.id) {
      await execute(feed({ req, filter: 'feed' }));
    } else {
      await execute(feed({ req }));
    }
  }
            ...
            <div className="col-md-9">
              ...
              <div className="article-preview">
                <div className="article-meta">
                  <a href="/profile.html"><img alt="author" src="http://i.imgur.com/Qr71crq.jpg" /></a>
                  <div className="info">
              ...
              <div className="article-preview">
                <div className="article-meta">
                  <a href="profile.html"><img alt="author" src="http://i.imgur.com/N4VcUeJ.jpg" /></a>
                  <div className="info">
                ...
                <a href="/" className="preview-link">
                  <h1>{'The song you won&quote; t ever stop singing.No matter how hard you try.'}</h1>
                  <p>This is the description for the post.</p>
                  <span>Read more ...</span>
                </a>
              </div>
